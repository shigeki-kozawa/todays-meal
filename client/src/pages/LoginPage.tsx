    ...
    <div className="min-h-screen min-h-[-webkit-fill-available] flex items-center justify-center p-4 safe-top safe-bottom">
      <div className="w-full max-w-md">
        ...
        <div className="card p-6 sm:p-8">
          <h2 className="font-display font-bold text-lg sm:text-xl text-gray-800 mb-5 sm:mb-6 text-center">ログイン</h2>
          {error && (
          ...
          <p className="text-center text-gray-600 mt-5 sm:mt-6 text-sm sm:text-base">
            アカウントをお持ちでない方は{' '}
            <Link to="/register" className="text-primary-600 active:text-primary-700 font-medium">
              新規登録
            </Link>
          </p>
        </div>
